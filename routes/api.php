...
Route::prefix('admin')->group(function () {
    Route::prefix('v1')->group(function () {
        Route::prefix('payments')->group(function () {
            ...
            Route::post('/create', [AdminPaymentController::class,'create'])->name('payment.create.v1');
            Route::post('/reverse', [AdminPaymentController::class,'reverse'])->name('transaction.reverse.v1');
        });
    });
});
